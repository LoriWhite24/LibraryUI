...
public class BookChekout {
	...
	public BookChekout(int checkout_id, int patron_id, String isbn, Date checkedout, Date due_date, Date returned) {
		super();
	...
	public String toString() {
		return "BookChekout [checkout_id=" + checkout_id + ", patron_id=" + patron_id + ", isbn=" + isbn
